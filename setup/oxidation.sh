...
Essential tools: fzf, ripgrep, dust, eza, bat, fd-find, zoxide, xh, hyperfine, 
                 tokei, just, tealdeer
...
if ! RUSTC_WRAPPER=sccache cargo install --locked \
    fzf ripgrep du-dust eza bat fd-find zoxide xh hyperfine tokei just tealdeer mcdu; then
