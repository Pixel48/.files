...
git config --global alias.here 's .'
...
git config --global alias.mdv 'm develop'
...
git config --global alias.sd 's .'
git config --global alias.sl 'shortlog'
git config --global alias.sq 'm --squash'
git config --global alias.squash 'm --squash'
git config --global alias.ss 'd --stat'
git config --global alias.st 'stash'
git config --global alias.stat 'status'
git config --global alias.stl 'st list'
git config --global alias.stlp 'st list -p'
git config --global alias.stls 'st list --stat'
git config --global alias.stm 'st push -m'
git config --global alias.sts 'st show'
git config --global alias.stsp 'st show -p'
...
git config --global alias.time 'log --graph --format="%C(yellow)%h%C(reset) %C(red)%an%C(reset) %s %C(blue)%ar%C(reset)"'
